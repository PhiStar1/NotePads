...
Partial Class Argument
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Der Pfad passt so nicht. " & vbCrLf & "Check nochmal, ob NotePads damit was anfangen kann!"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(227, 25)
        ToolStripLabel2.Text = "Dokumentpfad ist ungültig"
        ' 
        ' Argument
        ' 
