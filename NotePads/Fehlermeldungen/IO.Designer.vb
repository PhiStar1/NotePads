...
Partial Class IO
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(628, 50)
        Label1.TabIndex = 1
        Label1.Text = "Irgendwas läuft schief... NotePads kommt gerade nicht an das Dokument ran. " & vbCrLf & "Schließ mal andere Apps und versuch's nochmal!"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(364, 25)
        ToolStripLabel2.Text = "Eine andere App greift auf das Dokument zu"
        ' 
        ' IO
        ' 
