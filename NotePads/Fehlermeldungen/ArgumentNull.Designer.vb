...
Partial Class ArgumentNull
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Hm, Notepads braucht da was – sieht aus, als wäre der Dateipfad leer. " & vbCrLf & "Mach da mal was rein, ja?"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(100, 25)
        ToolStripLabel2.Text = "Leerer Pfad"
        ' 
        ' ArgumentNull
        ' 
