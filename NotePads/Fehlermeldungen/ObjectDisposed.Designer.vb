...
Partial Class ObjectDisposed
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(704, 25)
        Label1.TabIndex = 1
        Label1.Text = "Notepads hat gerade versucht, etwas mit 'ner gelöschten Komponente zu machen. Ups!"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(224, 25)
        ToolStripLabel2.Text = "Softwarekomponente fehlt"
        ' 
        ' ObjectDisposed
        ' 
