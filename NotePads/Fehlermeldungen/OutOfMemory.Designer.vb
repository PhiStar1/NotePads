...
Partial Class OutOfMemory
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Äh, NotePads ist gerade völlig überfordert... Kein Platz mehr im Kopf! " & vbCrLf & "Schließ mal was oder starte neu."
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(210, 25)
        ToolStripLabel2.Text = "Zu wenig Arbeitsspeicher"
        ' 
        ' OutOfMemory
        ' 
