...
Partial Class DirectoryNotFound
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Hoppla! Der Ordner scheint irgendwie verschwunden zu sein. " & vbCrLf & "Ist er noch da?"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(192, 25)
        ToolStripLabel2.Text = "Ordner nicht gefunden"
        ' 
        ' DirectoryNotFound
        ' 
