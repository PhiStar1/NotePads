...
Partial Class PathTooLong
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Wow, der Pfad ist echt zu lang für NotePads! " & vbCrLf & "Kürz ihn ein bisschen und versuch's nochmal, okay?"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(195, 25)
        ToolStripLabel2.Text = "Dokumentpfad zu lang"
        ' 
        ' PathTooLong
        ' 
