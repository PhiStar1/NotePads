...
Partial Class NotSupported
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Oh nein, dieser Pfad sieht komisch aus! " & vbCrLf & "Vielleicht nochmal kurz überprüfen?"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(119, 25)
        ToolStripLabel2.Text = "Pfad ungültig"
        ' 
        ' NotSupported
        ' 
