...
Partial Class UnsupportedFileDrag
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Das ist kein gültiger Datei-Drag! " & vbCrLf & "Versuch's nochmal mit einer Datei, die du in NotePads ziehen kannst."
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(170, 25)
        ToolStripLabel2.Text = "Drag-Drop ungültig"
        ' 
        ' UnsupportedFileDrag
        ' 
