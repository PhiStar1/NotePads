...
Partial Class UnauthorizedAccessRegistry
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Hey, NotePads kann nicht auf die Registrierung zugreifen! " & vbCrLf & "Hast du die nötigen Berechtigungen?"
        ' 
        ' Label2
        ' 
        ...
        MinimizeBox = False
        Name = "UnauthorizedAccessRegistry"
