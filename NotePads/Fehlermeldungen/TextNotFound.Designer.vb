...
Partial Class TextNotFound
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(TextNotFound))
        ...
        Label1.TabIndex = 1
        Label1.Text = "Notepads kann deinen angegebenen Text nicht im aktuell importierten Dokument finden."
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(383, 25)
        ToolStripLabel2.Text = "Zu suchender Text kann nicht gefunden werden"
        ' 
        ' TextNotFound
        ' 
