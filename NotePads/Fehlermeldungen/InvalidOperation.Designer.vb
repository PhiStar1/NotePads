...
Partial Class InvalidOperation
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Hm, Notepads kommt gerade nicht klar. " & vbCrLf & "Versuche es nochmal, bitte!"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(367, 25)
        ToolStripLabel2.Text = "Zustand einer Softwarekomponente ungültig"
        ' 
        ' InvalidOperation
        ' 
