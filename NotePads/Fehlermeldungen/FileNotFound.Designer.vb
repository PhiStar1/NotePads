...
Partial Class FileNotFound
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 1
        Label1.Text = "Hmmm... dieses Dokument gibt's wohl nicht. " & vbCrLf & "Hast du in NotePads den Pfad richtig eingegeben?"
        ' 
        ' Label2
        ' 
        ...
        ToolStripLabel2.Size = New Size(220, 25)
        ToolStripLabel2.Text = "Dokument nicht gefunden"
        ' 
        ' FileNotFound
        ' 
